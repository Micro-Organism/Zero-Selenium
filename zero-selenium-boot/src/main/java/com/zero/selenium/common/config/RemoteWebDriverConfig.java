package com.zero.selenium.common.config;
...
public class RemoteWebDriverConfig {
    ...
    public WebDriver remoteFirefoxDriver(){
        Capabilities capabilities = new DesiredCapabilities( "firefox", "", Platform.ANY);
    ...
    public WebDriver remoteChromeDriver(){
        Capabilities capabilities = new DesiredCapabilities( "chrome", "", Platform.ANY);
        return new RemoteWebDriver(this.url, capabilities);
    }
